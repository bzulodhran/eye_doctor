import 'package:eye_doctor/admin/admin.dart';
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Doctor", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Consultation", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Diagnostic", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Operation Theater", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Medical Store", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Oppointment", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Glasses Store", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Emergency Medicine", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Image.asset("image/optt.png",
                        ...
                        fit: BoxFit.fitWidth,),
                      //Icon(Icons.gavel_outlined,size: 70.0,color: Colors.green,),
                      Text("EYE CAMPS", style: new TextStyle(color: Colors.yellowAccent,fontSize: 14.0,fontWeight: FontWeight.bold,),)
                    ],
                  ),
                ),
              ),
