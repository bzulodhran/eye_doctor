...
import 'api/firebase_notifi_api.dart';

class noti_up extends StatefulWidget {
  @override
  _noti_upState createState() => _noti_upState();
}

class _noti_upState extends State<noti_up> {
  UploadTask? task;
  File? file;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Notification Upload"),
        centerTitle: true,
      ),
      body: Container(
  ...
  Future uploadFile() async {
    ...
    final destination = 'Notification/$fileName';
